...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		phoneNumberCount, err := userCollection.CountDocuments(ctx, bson.M{"phone": user.Phone})
		if err != nil {
			log.Panic(err)
		...
		// *user.Token, *user.RefreshToken, _ = helper.GenerateAllTokens(*user.Email, *user.FirstName, *user.LastName, *user.UserType, user.UserId)
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			fmt.Println(strings.Repeat("a", 30))
